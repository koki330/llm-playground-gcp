...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between p-4 bg-[#A61C4B] text-white">
      <div className="flex items-center gap-4">
        <h1 className="text-xl font-bold">Tecnos LLM Playground</h1>
        ...
        <div className="relative" ref={dropdownRef}>
          <button 
            ...
            className="p-2 rounded-md hover:bg-[#85163c] text-white transition-colors flex items-center gap-1"
      ...
      <div>
        <button 
          ...
          className="p-2 rounded-md hover:bg-[#85163c] text-white transition-colors"
