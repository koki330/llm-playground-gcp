...
- **ファイル添付時のチャット表示を改善:** PDF・Word・Excelファイルを添付した際、チャット上にファイル名が表示されるようになりました。これまでWord・Excelファイルの内容がチャット上にそのまま表示されていた問題も解消しています。

### 🗑️ 廃止

- **O3モデルの削除:** `O3`モデルを削除しました。リーゾニングタスクには`GPT-5`シリーズをご利用ください。

## 2025-12-10

### ✨ 新機能

- **複数ファイル同時添付機能:** チャットに複数のファイルや画像を同時に添付できるようになりました。
  - **複数画像の同時添付:** 2枚以上の画像を一度に選択して送信できます。全ての画像内容をAIが同時に認識・分析します。
  - **混合ファイル形式:** 画像とPDF、Excelなどの異なるファイル形式を同時に添付可能です。
  - **個別削除機能:** 添付した各ファイルに削除ボタンが表示され、個別に削除できます。
  - **対応モデル:** GPTシリーズ、Claude Sonnet 4.5、Geminiシリーズ全てで利用可能です。

### 🔧 改善
- **ページタイトルの最適化:** ブラウザタブのタイトルを「LLM Playground」に変更し、複数タブを開いた際の識別性を向上させました。

## 2025-12-01

### ✨ 新機能

- **Web検索機能（グラウンディング）の大幅拡充:** 複数のモデルでリアルタイムWeb検索機能が利用可能になりました。
  - **GPT-5シリーズ:** GPT-5.1、GPT-5、GPT-5-mini、GPT-5-nanoで、サイドバーの「Web検索」トグルをONにすることで、最新情報を検索して回答できるようになりました。
  - **Gemini 2.5シリーズ:** Gemini 2.5 ProとGemini 2.5 Flashで、サイドバーの「Web検索」トグルをONにすることで、Google検索を活用した回答が可能になりました。
  - **Gemini 3 Pro Preview:** 高度な推論モデルでもWeb検索機能が利用可能になり、最新情報と深い思考を組み合わせた回答を提供します。

### 🔧 改善

- **GPT-5の会話履歴参照の改善:** GPT-5シリーズで、Web検索のON/OFF切り替え時にも会話履歴が正しく参照されるようになりました。連続した質問にも安定して応答できます。

### 🗑️ 廃止

- **O4-miniモデルの削除:** `O4-mini`モデルを削除しました。リーゾニングタスクには`O3`または`GPT-5`シリーズをご利用ください。

## 2025-11-20

### ✨ 新機能

- **Gemini 3 Pro Previewモデルの追加:** Googleの最新リーゾニングモデル`Gemini 3 Pro Preview`を追加しました。高度な推論能力を持つ次世代モデルです。
  - **思考レベル設定:** サイドバーから推論の深さを調整できます。
    - **高（デフォルト）:** 最大推論モード。複雑な問題に対して深い思考プロセスで回答します。
    - **低:** 高速応答モード。よりスピーディーな応答が必要な場合に最適です。
  - 最大出力トークン数: 65,536トークン
  - 複雑な問題解決、数学、コーディングなどの高度なタスクに優れた性能を発揮します。
